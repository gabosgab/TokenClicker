...
const NEWS_DATA = [
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "inferencewatch", text: "Double-digit throughput. We've opened a file." },
      { account: "nveedia", text: "We see you. Keep going. Our roadmap depends on this." },
      { account: "normalperson_", text: "it's going faster now. this is either good or I need to unplug something" },
      { account: "vcman", text: "Double digits. The slide deck writes itself." },
      { account: "fakellon", text: "Forty tokens per second. Remind me of my quote about 40 things." },
      { account: "inferencewatch", text: "Throughput trending up. We've assigned a junior analyst. She seems fine with it." },
      { account: "fuxnews", text: "Sixty tokens per second: harmless hobby or threat to Western civilization? Our panel is leaning." },
      { account: "aibro", text: "double digits now. technically small but spiritually enormous 💫" },
      { account: "dailynews", text: "Token throughput climbs into double digits. Neighborhood power usage up. Coincidence sought." },
      { account: "guberment", text: "Double-digit throughput detected. We've formed a bipartisan commission. It has not met yet." },
      { account: "nveedia", text: "Seventy tokens per second on that hardware. Impressive given the circumstances." },
      { account: "normalperson_", text: "googled 'is making tokens good' and got an ad for tokens. suspect." },
      { account: "vcman", text: "Early traction. Not monetizable yet but the story is there." },
      { account: "inferencewatch", text: "Sustained double-digit output. We've updated our 'watch list' to 'active file.'" },
      { account: "fakellon", text: "I ran double-digit throughput on a rented server in 2009. Different times. Better servers." },
      { account: "fuxnews", text: "Eighty tokens per second. Is this what young people do now? We convened a panel. They left early." },
      { account: "aibro", text: "nobody believed in us at 10 tps. they will believe at 100. this is the way 🛣️" },
      { account: "dailynews", text: "Utility company reports unusual spike in one neighborhood. Resident offers no comment. Smiles slightly." },
      { account: "guberment", text: "I've asked my IT department to explain tokens. They submitted a four-hundred-page report. I haven't opened it." },
      { account: "nveedia", text: "Ninety TPS on consumer hardware. We have some concerns. Also some suggestions." },
      { account: "normalperson_", text: "the fan is spinning faster. the cat has moved away from the computer. the cat knows things." },
    ],
  },
  {
    condition: "tps",
    ...
    tweets: [
      ...
      { account: "normalperson_", text: "three digits. that's a lot right? is that a lot" },
      { account: "vcman", text: "Entering the Hundreds Club. Population: you and some very nervous competitors." },
      { account: "nveedia", text: "Demand signal received loud and clear." },
      { account: "inferencewatch", text: "Three-digit TPS is the threshold we use internally to separate 'hobby' from 'incident.'" },
      { account: "aibro", text: "500 tokens per second. this is genuinely unhinged. we love it 🌀" },
      { account: "normalperson_", text: "my electricity bill is a cry for help. from the electricity." },
      { account: "fakellon", text: "Triple digits. I started a company at 200 TPS once. It pivoted to rockets." },
      { account: "fuxnews", text: "Eight hundred tokens per second: is your family safe? Tips at eleven." },
      { account: "dailynews", text: "Regional grid operator reports 'unexplained demand.' Source not yet identified. Neighbors are looking at each other." },
      { account: "guberment", text: "Triple-digit throughput. I've been asked if I'm worried. I said no. I lied." },
      { account: "vcman", text: "Three-digit run rate. Our associate partner wants in. She only appears for real opportunities." },
      { account: "nveedia", text: "We've noticed your throughput. We'd like to discuss your next procurement cycle." },
      { account: "inferencewatch", text: "Nine hundred tokens per second is technically still triple digits. The gap is closing." },
      { account: "aibro", text: "three digits and CLIMBING. the only ceiling is the cloud and we are the cloud 🌩️" },
      { account: "normalperson_", text: "the neighbors asked why my apartment sounds like an airport. i said 'ambient music.'" },
      { account: "fakellon", text: "I produce 900 tokens per second just from my replies. Each character is a token. Think about it." },
      { account: "fuxnews", text: "What are tokens? Where do they come from? What do they want? We're covering this all week." },
      ...
      { account: "nveedia", text: "Seven hundred TPS. We see it. Jensen sees it. Jensen sees everything." },
      { account: "normalperson_", text: "asked my dad what tokens are. he said 'is it like Chuck E. Cheese.' maybe dad. maybe." },
      { account: "inferencewatch", text: "Triple-digit throughput is where most operations plateau. You have not plateaued. Noted." },
    ],
  },
  {
    condition: "tps",
    ...
    tweets: [
      ...
      { account: "guberment", text: "I've been told we're producing thousands of tokens per second. I've called FEMA. They said it wasn't their department." },
      { account: "dailynews", text: "Kilotoken throughput: blessing or curse? We put the question to a focus group. They asked what a token was." },
      { account: "inferencewatch", text: "Kilotoken throughput is where the industry starts paying attention. Attention paid." },
      { account: "aibro", text: "1000+ tps. we are no longer a hobby. we are a situation 🚨" },
      { account: "normalperson_", text: "the power company called. i said 'yes this is fine.' they did not sound convinced." },
      { account: "fuxnews", text: "Two thousand tokens per second. We asked an expert. He called it 'a number.'" },
      { account: "dailynews", text: "Town selectmen vote to investigate 'the token situation.' Vote was 3-2. Meeting described as 'tense.'" },
      { account: "fakellon", text: "Four-figure throughput. I solved the 'impossible' by ignoring the constraints. Anyone can do this." },
      { account: "guberment", text: "I've requested a classified briefing. The briefing was classified. From me." },
      { account: "vcman", text: "Kilo-scale throughput is where the real money lives. Ours and, potentially, yours." },
      { account: "nveedia", text: "At four-figure TPS you may qualify for our enterprise support tier. We're reaching out." },
      { account: "inferencewatch", text: "Five thousand tokens per second. The gap between this and 'concerning' is narrowing." },
      { account: "aibro", text: "mid-four-digits per second. we are what they feared when they wrote the white papers 📄" },
      { account: "normalperson_", text: "my router is scared. i can tell because it's warm and quiet. routers should not be quiet." },
      { account: "fuxnews", text: "Three thousand tokens per second: is AI out of control? Guests: two calm people and one who is not." },
      { account: "dailynews", text: "Fire department conducted a wellness check. Cleared the scene. Did not explain what they saw." },
      { account: "fakellon", text: "I advised three startups doing exactly this. All three pivoted. Their loss." },
      { account: "guberment", text: "I've introduced the Responsible Token Act. It has zero co-sponsors. That's also a number." },
      { account: "vcman", text: "At this throughput we can model a real exit. Three to five years. Maybe two. Probably seven." },
      { account: "nveedia", text: "Eight thousand tokens per second. We've flagged your account for a friendly conversation." },
      { account: "inferencewatch", text: "Throughput stability in four-figure range confirmed. We're calling this 'scale without incident.' For now." },
    ],
  },
  {
    condition: "tps",
    ...
    tweets: [
      ...
      { account: "nveedia", text: "H100 allocations quietly reassigned your direction. You're welcome, and also thank you." },
      { account: "dailynews", text: "County power grid reportedly 'reassigned' to support local token operation. Officials describe situation as 'novel.'" },
      { account: "guberment", text: "I've introduced legislation to study this. The legislation is still loading." },
      { account: "inferencewatch", text: "Five-figure throughput puts you in a percentile we don't publish. Trust us." },
      { account: "aibro", text: "we are now faster than most companies' entire AI budgets 💸" },
      { account: "normalperson_", text: "the smart meter on my house started sending me personal messages. they're not friendly." },
      { account: "fuxnews", text: "Fifty thousand tokens per second. We asked viewers to explain this. They could not. We also cannot." },
      { account: "dailynews", text: "Regional power authority issues statement. Statement reads: 'We are aware.'" },
      { account: "fakellon", text: "Thirty thousand TPS. Impressive. I was doing sixty thousand on my yacht's compute cluster last Thursday." },
      { account: "guberment", text: "FEMA has not been deployed. I want to be clear about that. Yet." },
      { account: "vcman", text: "Five-figure throughput means the TAM just got real. We've convened an emergency LP call." },
      { account: "nveedia", text: "At this throughput you may be eligible for our Hyperscaler designation. You know what you did." },
      { account: "inferencewatch", text: "Seventy thousand TPS. We've stopped using the word 'operation' and switched to 'apparatus.'" },
      { account: "aibro", text: "five figures. we are now measurable on radar 🛰️" },
      { account: "normalperson_", text: "FBI showed up. asked some questions. left without explanation. seemed satisfied. weird visit." },
      { account: "fuxnews", text: "Token operation hits five figures per second. Scientists describe this as 'a lot.' They are scientists." },
      { account: "dailynews", text: "Two neighboring towns hold a joint town hall to discuss 'the electromagnetic situation.' Packed room. No resolutions." },
      { account: "fakellon", text: "I am watching you. Not in a threatening way. In a competitive way. Mostly threatening." },
      { account: "vcman", text: "At five figures we're no longer talking about your runway. We're talking about your legacy." },
      { account: "nveedia", text: "Ninety thousand TPS. Jensen has personally been notified. He's written something in his notebook." },
      { account: "inferencewatch", text: "The analysts who called this 'a phase' have quietly deleted their posts." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "inferencewatch", text: "Six-figure throughput. We've retired all prior models. New model: awe." },
      { account: "dailynews", text: "Token velocity now exceeds that of several small nations. Nations unnamed. They know who they are." },
      { account: "guberment", text: "Formally requesting UN involvement. They said they'd get back to us. It's been three weeks." },
      { account: "inferencewatch", text: "Six-figure TPS. The vocabulary we use for this does not exist yet. We are coining terms." },
      { account: "aibro", text: "we are printing tokens faster than reality can process them. REALITY IS THE BOTTLENECK 🌐" },
      { account: "normalperson_", text: "the sun seems brighter near the building. that can't be from tokens right. right?" },
      { account: "fuxnews", text: "A hundred thousand tokens per second. We've given up trying to explain this. Goodnight." },
      ...
      { account: "vcman", text: "At six-figure throughput, you're not raising money. Money is coming to you." },
      { account: "nveedia", text: "We've assigned a dedicated relationship manager. She will be calling. Please answer." },
      { account: "inferencewatch", text: "Two hundred thousand TPS. We have started referring to your operation in the passive voice." },
      { account: "aibro", text: "quarter million per second. we are indistinguishable from a small national AI initiative 🏳️" },
      { account: "normalperson_", text: "compass stopped working near my house. probably fine. definitely the tokens." },
      ...
      { account: "fakellon", text: "I've decided to describe my own operation as being 'in the same space.' This is generous to me." },
      { account: "guberment", text: "I have been asked not to comment further. I am commenting further. No further comment." },
      { account: "vcman", text: "We don't model this. There is no box. The box was deprecated at fifty thousand." },
      { account: "nveedia", text: "Jensen would like to visit. Jensen will be visiting. Jensen has arrived." },
      { account: "inferencewatch", text: "We have added your operation to the Systemic Significance register. This is not a list you want to be on. Congratulations." },
    ],
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "I have a Mac. I use it for emails. I had no idea it could do this." },
      ...
      { account: "guberment", text: "I've asked Apple about this. They sent me a brochure. The brochure is very well-designed." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "I've been told these chips are on a federal watchlist. I'm also on a federal watchlist. We have something in common." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "nveedia", text: "H100 acquisition noted. This is exactly what Jensen had in mind." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "I've been briefed on unified memory architecture. I remember none of it." },
      ...
      { account: "guberment", text: "Unified compute. I find the word 'unified' comforting. Everything else about this: less so." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "nveedia", text: "B200 acquisition logged. Jensen is pleased. Jensen is always pleased." },
      ...
      { account: "guberment", text: "The B200 is on three export watchlists and one internal memo I can't find. Busy week." },
      ...
      { account: "fakellon", text: "I ordered the B200 before it existed. Jensen personally called. We argued about naming. He won." },
      ...
      { account: "guberment", text: "I've approved a memo acknowledging the existence of the B200. The memo is under review." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "Rack-scale compute: I've added this to the vocabulary list my staff gave me. It's a long list." },
      ...
      { account: "guberment", text: "I've requested a tour of this rack. I was not invited. I've requested again." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "A chip that works like a brain. I've asked the NIH, the NSF, and my nephew. All three are confused." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "There are GPUs around the sun now. I've briefed the President. He asked if they were ours. I said 'sort of.'" },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "guberment", text: "One thousand tokens produced. I've been told to acknowledge this. Acknowledged." },
  ...
  },
  {
    ...
    threshold: 10000,
    tweets: [
      { account: "guberment", text: "Ten thousand tokens. I've asked my chief of staff to explain this. She quit." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "nveedia", text: "Hundred-million output. We've flagged your account for recognition at Jensen's next keynote. Subject to change." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "nveedia", text: "One billion tokens. Jensen has a name for people who reach this milestone. You have that name now." },
  ...
  },
  {
    ...
    tweets: [
      ...
      { account: "nveedia", text: "Ten billion tokens. The supply chain thanks you. Jensen personally thanks you. Jensen is never not working." },
